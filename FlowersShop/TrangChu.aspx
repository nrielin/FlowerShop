...
<body runat="server">
        <header>
        <div class="visit-count" runat="server" id="visitCount"></div> <!-- Phần số lượng truy cập -->
        ...
        <div class="icons">
            <a href="searchItem.html" class="fas fa-heart"></a>
...
<!-- home section -->
   <section class="home" id="home">
        <div class="content">
            <h3>fresh flowers</h3>
            <span>natural and beautiful flowers </span><br>
